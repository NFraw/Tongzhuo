# Huiming (Hui Ming) — Game Rules

A 2-4 player game based on **25 playing cards**. The rules are simple, but full of strategy.

> "Hui Ming" symbolizes the constant transition between face-up and face-down cards.
...
Lay the 25 cards face down in a **5x5 grid** on the table. The center card is always the Joker; the other 24 cards are shuffled completely at random.
